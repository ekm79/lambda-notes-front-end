import { GETTING_NOTES, 
        ...
        export const noteReducers = (state = initialState, {type, payload}) => {
            switch(type){
                ...
                case ADDING_TAGS: 
                    return {...state, addingTags: true}
                case TAGS_ADDED:
                    return {...state, addingTags: false, tagsAdded: true, tags: payload}
                case ADD_TAGS_FAILED:
                    return {...state, addingTags: false, error: payload}
